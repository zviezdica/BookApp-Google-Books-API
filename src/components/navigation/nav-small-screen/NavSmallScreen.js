            ...
            <div className="container flex justify-between items-center py-10 ">
                <div className="logo w-max opacity-90">
                    <Link to="/" >
                        ...
                        <h4 className="uppercase text-dark-blue tracking-widest text-17 -mt-10 mb-5 text-center w-max mx-auto">libar</h4>
                    </Link>
                </div>
                <div className="relative">
                    <button className="absolute top-1/2 left-1/2 -translate-x-3/5 -translate-y-1/2 py-2 px-15 border-2 rounded-sm border-solid border-dark-blue uppercase text-17 transition-all duration-300 hover:bg-dark-blue hover:text-white whitespace-nowrap">log in</button>
                </div>
